package com.unionpay.rpc.benchmark.grpc.client;

import com.unionpay.rpc.benchmark.grpc.user.User;
import com.unionpay.rpc.benchmark.grpc.user.UserRequest;
import com.unionpay.rpc.benchmark.grpc.user.UserServiceGrpc;
