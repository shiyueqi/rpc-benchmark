...
public class UserService {
  ...
  public interface AsyncIface {
    ...
    public void getUser(long userId, AsyncMethodCallback resultHandler) throws TException;

    public void getUserName(long userId, AsyncMethodCallback resultHandler) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_getUser(long userId) throws TException
    {
    ...
    public void send_getUserName(long userId) throws TException
    {
    ...
    public String recv_getUserName() throws TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class getUser_call extends org.apache.thrift.async.TAsyncMethodCall {
      private long userId;
      public getUser_call(long userId, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
    ...
    public static class getUserName_call extends org.apache.thrift.async.TAsyncMethodCall {
      private long userId;
      public getUserName_call(long userId, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.userId = userId;
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getUserName<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getUserName_args> {
      ...
      public getUserName_result getResult(I iface, getUserName_args args) throws TException {
        getUserName_result result = new getUserName_result();
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getUserName<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getUserName_args, String> {
      ...
      public void start(I iface, getUserName_args args, AsyncMethodCallback<String> resultHandler) throws TException {
  ...
  public static class getUserName_args implements org.apache.thrift.TBase<getUserName_args, getUserName_args._Fields>, java.io.Serializable, Cloneable, Comparable<getUserName_args>   {
    ...
    private static class getUserName_argsStandardScheme extends StandardScheme<getUserName_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getUserName_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getUserName_args struct) throws TException {
        struct.validate();
    ...
    private static class getUserName_argsTupleScheme extends TupleScheme<getUserName_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getUserName_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetUserId()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getUserName_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.userId = iprot.readI64();
  ...
  public static class getUserName_result implements org.apache.thrift.TBase<getUserName_result, getUserName_result._Fields>, java.io.Serializable, Cloneable, Comparable<getUserName_result>   {
    ...
    private static class getUserName_resultStandardScheme extends StandardScheme<getUserName_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getUserName_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getUserName_result struct) throws TException {
        struct.validate();
    ...
    private static class getUserName_resultTupleScheme extends TupleScheme<getUserName_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getUserName_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getUserName_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readString();
